...
@implementation accValues
-(NSString*)description
{
    NSDictionary *dict = [NSDictionary dictionaryWithObjects:@[self.accX,self.accY,self.accZ] forKeys:@[@"X",@"Y",@"Z"]];
...
-(NSString*)description
{
    NSDictionary *dict = [NSDictionary dictionaryWithObjects:@[self.gyroX,self.gyroY,self.gyroZ] forKeys:@[@"X",@"Y",@"Z"]];
    NSString *desc = [dict description];
    desc = [desc stringByReplacingOccurrencesOfString:@"\"" withString:@""];
