...
- (IBAction)save:(UIButton *)sender
{
    ...
    {
        [[[UIAlertView alloc] initWithTitle:@"" message:@"No Data To Upload" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    ...
    else
    {
        ...
        [self uploadFileWithURL:fileURL fileSize:fileSize inBucket:BUCKET_NAME asfileName:fileName];
        [self cancel];
    }
}
...
-(void) logValues:(NSTimer*)timer
{
    ...
    [lblDataPointsCount setText:[NSString stringWithFormat:@"Data Points : %lu",(unsigned long)[[[TestDetails sharedInstance] dataPoints] count]]];
}
